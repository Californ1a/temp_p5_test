...
<template>
	<div id="viewFrac_main">
		<table id="viewFrac_table">
			...
			<tr>
				<td>
					<FractalCanvas :draw="firstCanvasDraw" :resolutionMulti="resolution" id="viewFrac_A" />
				</td>
				<td>
					<FractalCanvas :draw="secondCanvasDraw" :resolutionMulti="resolution" id="viewFrac_B" />
				</td>
				<td>
