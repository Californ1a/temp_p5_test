...
<template>
	...
	<div id="footer">
		...
		<input id="renderButton" v-description="'Renders the fractal with all of its properties in the corrisponding panel'" @click="Render(iterationNum, boundaryNum)" type="button" value="Render" />
	</div>
</template>
