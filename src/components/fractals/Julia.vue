...
<template>
  <div @mouseover="emit('descText', updateDescriptionText('The initial X value to begin rendering the Julia fractal from'))" @mouseleave="emit('descText', updateDescriptionText(''))">
    <label for="xInit">Initial X point: </label>
    <input v-model="xInit" id="xInit" type="number" name="xInit" min="-1000" max="1000" />
  </div>
  <br/>
  <div @mouseover="emit('descText', updateDescriptionText('The initial Y value to begin rendering the Julia fractal from'))" @mouseleave="emit('descText', updateDescriptionText(''))">
